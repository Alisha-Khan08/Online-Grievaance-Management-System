				    ...
				    <div class="container-fluid">
				        ...
				        <div id="navbar" class="navbar-collapse collapse">
				            <ul class="nav navbar-nav navbar-right">
				                <li class=""><a href="homes">Home</a></li>
			...
			<div class="container">
				<div class="row">	
					<div class="col-md-10 col-md-offset-1 col-sm-12 text-center">
						<h2>VIEW COMPLAINT STATUS HERE</h2>
						<p class="lead">Enter Your Complaint Registration Number</p>
						        ...
						        <div class="item-top form-inline">
						            <div class="form-group">
						                <div class="input-group2">
						                    ...
						                    <input type="text" class="form-control" id="urladres" name="id" placeholder="complaint registration number">
						                </div>
						            </div>
						            <input type="submit" name="send" value="View" class="btn btn-default" />
						        </div>
						    </div>
						</form>
						<%
						...
						<h1><%=complaintRegisterDTO.getProblems() %></h1>
						<h1><%=complaintRegisterDTO.getComplaintDescription() %></h1>
						<h1><%=complaintRegisterDTO.getFeedback() %></h1>
						<%} %>
					</div><!-- end col -->
				</div><!-- end row -->
			</div><!-- end container -->
